...
const AboutUs = () => {
  ...
  const p1 = "Welcome to Bamber Ranch! We are so pleased to share with you a treasure\n" +
  ...
  const p2 = "Jack cares for his herd with great compassion and pride. A ranch of\n" +
  ...
  const p3 = "On the ranch today, there is a dog named Rooster and we have about 10\n" +
